...
/// 1. `test_deposit_and_withdrawal_flow`: Verifies a full transaction flow.
///    Deposits tokens, checks balances, retrieves the generated root, and
///    withdraws using a mock ZK proof string, checking for double-spends.
/// 2. `test_withdraw_invalid_root`: Ensures that arbitrary historical Merkle
///    roots not generated by the contract are strictly rejected during withdrawal.
